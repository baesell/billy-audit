...
download_data = invoice_data.merge(verified_data_bol, 'left', on=['bill_of_lading', 'service_provider', 'origin_code', 'destination_code', 'invoice_currency', 'invoice_amount'])
